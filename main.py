...
while True:
    ...
    for y, row in enumerate(map_data):
        for x, tile in enumerate(row):
            if tile == 1:
                pygame.draw.rect(tile_1, (255,255,255), pygame.Rect(tile_1.get_rect()))
                display.blit(tile_1, ((160 + x * 32 - y * 32) - scroll[0], (100 + x * 16 + y * 16) - scroll[1]))
            if tile == 2:
                pygame.draw.rect(tile_2, (255, 255, 255), pygame.Rect(tile_1.get_rect()))
                display.blit(tile_2, ((160 + x * 32 - y * 32) - scroll[0], (100 + x * 16 + y * 16) - scroll[1]))
            if tile == 3:
                pygame.draw.rect(tile_3, (255, 255, 255), pygame.Rect(tile_1.get_rect()))
                display.blit(tile_3, ((160 + x * 32 - y * 32) - scroll[0], (76 + x * 16 + y * 16) - scroll[1]))
            if tile == 4:
                pygame.draw.rect(tile_4, (255, 255, 255), pygame.Rect(tile_1.get_rect()))
